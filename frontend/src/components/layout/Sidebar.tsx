...
const NAV = [
  ...
  { label: 'Backtesting',       path: '/backtesting',  icon: FlaskConical, section: 'ANALYTICS' },
                ...
                return (
                  <NavLink key={path} to={path}>
                    ...
                    >
                      ...
                      <span className={cn(
                        'whitespace-nowrap opacity-0 transition-opacity duration-150 group-hover/sidebar:opacity-100',
